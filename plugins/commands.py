...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('✪ Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/pmmoviesss"),
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            await message.reply_text(
                text=f"<b>Hey {message.from_user.mention}, You are successfully verified 🤡\nNow you have unlimited access for all movies till next Verification (24 hrs) 😎</b>",
                protect_content=True
            )
    ...
    if data.startswith("sendfiles"):
        ...
        for file in files:
            ...
            if not await check_verification(client, message.from_user.id) and VERIFY == True:
                ...
                await message.reply_text(
                    text="<b>You are not Verified Today 😁\nTap on the Verify button & Get Unlimited Access For till next Verification (24hrs) 😏</b>",
                    protect_content=True,
                    reply_markup=InlineKeyboardMarkup(btn)
                )
                return

...
BOT_TOKEN = environ.get('BOT_TOKEN', "6657216952:AAG-6qWe5cktEUjFAzB5a73egFtH7UcptxU")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001857033200').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://TOKYO:TOKYO@cluster0.n7agzp1.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp")
...
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', 'ade16f386d69aa3d86d6320b5b2c906996a8d2a6)
